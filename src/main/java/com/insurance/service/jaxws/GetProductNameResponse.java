...
@XmlRootElement(name = "getProductNameResponse", namespace = "http://service.insurance.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getProductNameResponse", namespace = "http://service.insurance.com/")
